...
class PrfUpd(forms.ModelForm):
	class Meta:
		model = User
		fields = ["username","first_name","last_name","hospital_name","email","dob","gender","ph_no","pan_no","address","city","postal_code","state","country","img"]
		widgets = {
		"username":forms.TextInput(attrs={
			"class":"form-control my-2",
			"readOnly":True,
			}),
		"first_name":forms.TextInput(attrs={"class":"form-control my-2","placeholder":"Enter first name"}),
		"last_name":forms.TextInput(attrs={"class":"form-control my-2","placeholder":"Enter last name"}),
